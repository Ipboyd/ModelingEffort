function [T,On_V,On_g_ad,Off_V,Off_g_ad,R1On_V,R1On_g_ad,R1Off_V,R1Off_g_ad,S1OnOff_V,S1OnOff_g_ad,R2On_V,R2On_g_ad,R2Off_V,R2Off_g_ad,S2OnOff_V,S2OnOff_g_ad,R3On_V,R3On_g_ad,R3Off_V,R3Off_g_ad,S3OnOff_V,S3OnOff_g_ad,R1On_On_PSC_s,R1On_On_PSC_x,R1On_On_PSC_F,R1On_On_PSC_P,R1On_On_PSC_q,S1OnOff_On_PSC_s,S1OnOff_On_PSC_x,S1OnOff_On_PSC_F,S1OnOff_On_PSC_P,S1OnOff_On_PSC_q,R1On_S1OnOff_PSC_s,R1On_S1OnOff_PSC_x,R1On_S1OnOff_PSC_F,R1On_S1OnOff_PSC_P,R1On_S1OnOff_PSC_q,R1Off_S1OnOff_PSC_s,R1Off_S1OnOff_PSC_x,R1Off_S1OnOff_PSC_F,R1Off_S1OnOff_PSC_P,R1Off_S1OnOff_PSC_q,R1Off_Off_PSC_s,R1Off_Off_PSC_x,R1Off_Off_PSC_F,R1Off_Off_PSC_P,R1Off_Off_PSC_q,S1OnOff_Off_PSC_s,S1OnOff_Off_PSC_x,S1OnOff_Off_PSC_F,S1OnOff_Off_PSC_P,S1OnOff_Off_PSC_q,R2On_R1On_PSC_s,R2On_R1On_PSC_x,R2On_R1On_PSC_F,R2On_R1On_PSC_P,R2On_R1On_PSC_q,S2OnOff_R1On_PSC_s,S2OnOff_R1On_PSC_x,S2OnOff_R1On_PSC_F,S2OnOff_R1On_PSC_P,S2OnOff_R1On_PSC_q,R2On_S2OnOff_PSC_s,R2On_S2OnOff_PSC_x,R2On_S2OnOff_PSC_F,R2On_S2OnOff_PSC_P,R2On_S2OnOff_PSC_q,R2Off_S2OnOff_PSC_s,R2Off_S2OnOff_PSC_x,R2Off_S2OnOff_PSC_F,R2Off_S2OnOff_PSC_P,R2Off_S2OnOff_PSC_q,R2Off_R1Off_PSC_s,R2Off_R1Off_PSC_x,R2Off_R1Off_PSC_F,R2Off_R1Off_PSC_P,R2Off_R1Off_PSC_q,S2OnOff_R1Off_PSC_s,S2OnOff_R1Off_PSC_x,S2OnOff_R1Off_PSC_F,S2OnOff_R1Off_PSC_P,S2OnOff_R1Off_PSC_q,R3On_R2On_PSC_s,R3On_R2On_PSC_x,R3On_R2On_PSC_F,R3On_R2On_PSC_P,R3On_R2On_PSC_q,S3OnOff_R2On_PSC_s,S3OnOff_R2On_PSC_x,S3OnOff_R2On_PSC_F,S3OnOff_R2On_PSC_P,S3OnOff_R2On_PSC_q,R3On_S3OnOff_PSC_s,R3On_S3OnOff_PSC_x,R3On_S3OnOff_PSC_F,R3On_S3OnOff_PSC_P,R3On_S3OnOff_PSC_q,R3Off_S3OnOff_PSC_s,R3Off_S3OnOff_PSC_x,R3Off_S3OnOff_PSC_F,R3Off_S3OnOff_PSC_P,R3Off_S3OnOff_PSC_q,R3Off_R2Off_PSC_s,R3Off_R2Off_PSC_x,R3Off_R2Off_PSC_F,R3Off_R2Off_PSC_P,R3Off_R2Off_PSC_q,S3OnOff_R2Off_PSC_s,S3OnOff_R2Off_PSC_x,S3OnOff_R2Off_PSC_F,S3OnOff_R2Off_PSC_P,S3OnOff_R2Off_PSC_q,R3On_R3On_iNoise_V3_sn,R3On_R3On_iNoise_V3_xn,On_V_spikes,Off_V_spikes,R1On_V_spikes,R1Off_V_spikes,S1OnOff_V_spikes,R2On_V_spikes,R2Off_V_spikes,S2OnOff_V_spikes,R3On_V_spikes,R3Off_V_spikes,S3OnOff_V_spikes,On_On_IC_iIC,Off_Off_IC_iIC,R1On_On_PSC_syn,S1OnOff_On_PSC_syn,R1On_S1OnOff_PSC_syn,R1Off_S1OnOff_PSC_syn,R1Off_Off_PSC_syn,S1OnOff_Off_PSC_syn,R2On_R1On_PSC_syn,S2OnOff_R1On_PSC_syn,R2On_S2OnOff_PSC_syn,R2Off_S2OnOff_PSC_syn,R2Off_R1Off_PSC_syn,S2OnOff_R1Off_PSC_syn,R3On_R2On_PSC_syn,S3OnOff_R2On_PSC_syn,R3On_S3OnOff_PSC_syn,R3Off_S3OnOff_PSC_syn,R3Off_R2Off_PSC_syn,S3OnOff_R2Off_PSC_syn,On_R,On_tau,On_Imask,Off_R,Off_tau,Off_Imask,R1On_R,R1On_tau,R1On_Imask,R1Off_R,R1Off_tau,R1Off_Imask,S1OnOff_R,S1OnOff_tau,S1OnOff_Imask,R2On_R,R2On_tau,R2On_Imask,R2Off_R,R2Off_tau,R2Off_Imask,S2OnOff_R,S2OnOff_tau,S2OnOff_Imask,R3On_R,R3On_tau,R3On_Imask,R3Off_R,R3Off_tau,R3Off_Imask,S3OnOff_R,S3OnOff_tau,S3OnOff_Imask,On_On_IC_netcon,On_On_IC_input,Off_Off_IC_netcon,Off_Off_IC_input,R1On_On_PSC_netcon,R1On_On_PSC_scale,S1OnOff_On_PSC_netcon,S1OnOff_On_PSC_scale,R1On_S1OnOff_PSC_netcon,R1On_S1OnOff_PSC_scale,R1Off_S1OnOff_PSC_netcon,R1Off_S1OnOff_PSC_scale,R1Off_Off_PSC_netcon,R1Off_Off_PSC_scale,S1OnOff_Off_PSC_netcon,S1OnOff_Off_PSC_scale,R2On_R1On_PSC_netcon,R2On_R1On_PSC_scale,S2OnOff_R1On_PSC_netcon,S2OnOff_R1On_PSC_scale,R2On_S2OnOff_PSC_netcon,R2On_S2OnOff_PSC_scale,R2Off_S2OnOff_PSC_netcon,R2Off_S2OnOff_PSC_scale,R2Off_R1Off_PSC_netcon,R2Off_R1Off_PSC_scale,S2OnOff_R1Off_PSC_netcon,S2OnOff_R1Off_PSC_scale,R3On_R2On_PSC_netcon,R3On_R2On_PSC_scale,S3OnOff_R2On_PSC_netcon,S3OnOff_R2On_PSC_scale,R3On_S3OnOff_PSC_netcon,R3On_S3OnOff_PSC_scale,R3Off_S3OnOff_PSC_netcon,R3Off_S3OnOff_PSC_scale,R3Off_R2Off_PSC_netcon,R3Off_R2Off_PSC_scale,S3OnOff_R2Off_PSC_netcon,S3OnOff_R2Off_PSC_scale,R3On_R3On_iNoise_V3_netcon,R3On_R3On_iNoise_V3_token,R3On_R3On_iNoise_V3_scale]=solve_ode(tspan, downsample_factor, random_seed, solver, disk_flag, dt, datafile, mex_flag, verbose_flag, On_C, On_g_L, On_E_L, On_noise, On_t_ref, On_E_k, On_tau_ad, On_g_inc, On_Itonic, On_V_thresh, On_V_reset, On_Npop, Off_C, Off_g_L, Off_E_L, Off_noise, Off_t_ref, Off_E_k, Off_tau_ad, Off_g_inc, Off_Itonic, Off_V_thresh, Off_V_reset, Off_Npop, R1On_C, R1On_g_L, R1On_E_L, R1On_noise, R1On_t_ref, R1On_E_k, R1On_tau_ad, R1On_g_inc, R1On_Itonic, R1On_V_thresh, R1On_V_reset, R1On_Npop, R1Off_C, R1Off_g_L, R1Off_E_L, R1Off_noise, R1Off_t_ref, R1Off_E_k, R1Off_tau_ad, R1Off_g_inc, R1Off_Itonic, R1Off_V_thresh, R1Off_V_reset, R1Off_Npop, S1OnOff_C, S1OnOff_g_L, S1OnOff_E_L, S1OnOff_noise, S1OnOff_t_ref, S1OnOff_E_k, S1OnOff_tau_ad, S1OnOff_g_inc, S1OnOff_Itonic, S1OnOff_V_thresh, S1OnOff_V_reset, S1OnOff_Npop, R2On_C, R2On_g_L, R2On_E_L, R2On_noise, R2On_t_ref, R2On_E_k, R2On_tau_ad, R2On_g_inc, R2On_Itonic, R2On_V_thresh, R2On_V_reset, R2On_Npop, R2Off_C, R2Off_g_L, R2Off_E_L, R2Off_noise, R2Off_t_ref, R2Off_E_k, R2Off_tau_ad, R2Off_g_inc, R2Off_Itonic, R2Off_V_thresh, R2Off_V_reset, R2Off_Npop, S2OnOff_C, S2OnOff_g_L, S2OnOff_E_L, S2OnOff_noise, S2OnOff_t_ref, S2OnOff_E_k, S2OnOff_tau_ad, S2OnOff_g_inc, S2OnOff_Itonic, S2OnOff_V_thresh, S2OnOff_V_reset, S2OnOff_Npop, R3On_C, R3On_g_L, R3On_E_L, R3On_noise, R3On_t_ref, R3On_E_k, R3On_tau_ad, R3On_g_inc, R3On_Itonic, R3On_V_thresh, R3On_V_reset, R3On_Npop, R3Off_C, R3Off_g_L, R3Off_E_L, R3Off_noise, R3Off_t_ref, R3Off_E_k, R3Off_tau_ad, R3Off_g_inc, R3Off_Itonic, R3Off_V_thresh, R3Off_V_reset, R3Off_Npop, S3OnOff_C, S3OnOff_g_L, S3OnOff_E_L, S3OnOff_noise, S3OnOff_t_ref, S3OnOff_E_k, S3OnOff_tau_ad, S3OnOff_g_inc, S3OnOff_Itonic, S3OnOff_V_thresh, S3OnOff_V_reset, S3OnOff_Npop, On_On_IC_trial, On_On_IC_locNum, On_On_IC_label, On_On_IC_t_ref, On_On_IC_t_ref_rel, On_On_IC_rec, On_On_IC_g_postIC, On_On_IC_E_exc, Off_Off_IC_trial, Off_Off_IC_locNum, Off_Off_IC_label, Off_Off_IC_t_ref, Off_Off_IC_t_ref_rel, Off_Off_IC_rec, Off_Off_IC_g_postIC, Off_Off_IC_E_exc, R1On_On_PSC_ESYN, R1On_On_PSC_tauD, R1On_On_PSC_tauR, R1On_On_PSC_delay, R1On_On_PSC_gSYN, R1On_On_PSC_fF, R1On_On_PSC_fP, R1On_On_PSC_tauF, R1On_On_PSC_tauP, R1On_On_PSC_maxF, S1OnOff_On_PSC_ESYN, S1OnOff_On_PSC_tauD, S1OnOff_On_PSC_tauR, S1OnOff_On_PSC_delay, S1OnOff_On_PSC_gSYN, S1OnOff_On_PSC_fF, S1OnOff_On_PSC_fP, S1OnOff_On_PSC_tauF, S1OnOff_On_PSC_tauP, S1OnOff_On_PSC_maxF, R1On_S1OnOff_PSC_ESYN, R1On_S1OnOff_PSC_tauD, R1On_S1OnOff_PSC_tauR, R1On_S1OnOff_PSC_delay, R1On_S1OnOff_PSC_gSYN, R1On_S1OnOff_PSC_fF, R1On_S1OnOff_PSC_fP, R1On_S1OnOff_PSC_tauF, R1On_S1OnOff_PSC_tauP, R1On_S1OnOff_PSC_maxF, R1Off_S1OnOff_PSC_ESYN, R1Off_S1OnOff_PSC_tauD, R1Off_S1OnOff_PSC_tauR, R1Off_S1OnOff_PSC_delay, R1Off_S1OnOff_PSC_gSYN, R1Off_S1OnOff_PSC_fF, R1Off_S1OnOff_PSC_fP, R1Off_S1OnOff_PSC_tauF, R1Off_S1OnOff_PSC_tauP, R1Off_S1OnOff_PSC_maxF, R1Off_Off_PSC_ESYN, R1Off_Off_PSC_tauD, R1Off_Off_PSC_tauR, R1Off_Off_PSC_delay, R1Off_Off_PSC_gSYN, R1Off_Off_PSC_fF, R1Off_Off_PSC_fP, R1Off_Off_PSC_tauF, R1Off_Off_PSC_tauP, R1Off_Off_PSC_maxF, S1OnOff_Off_PSC_ESYN, S1OnOff_Off_PSC_tauD, S1OnOff_Off_PSC_tauR, S1OnOff_Off_PSC_delay, S1OnOff_Off_PSC_gSYN, S1OnOff_Off_PSC_fF, S1OnOff_Off_PSC_fP, S1OnOff_Off_PSC_tauF, S1OnOff_Off_PSC_tauP, S1OnOff_Off_PSC_maxF, R2On_R1On_PSC_ESYN, R2On_R1On_PSC_tauD, R2On_R1On_PSC_tauR, R2On_R1On_PSC_delay, R2On_R1On_PSC_gSYN, R2On_R1On_PSC_fF, R2On_R1On_PSC_fP, R2On_R1On_PSC_tauF, R2On_R1On_PSC_tauP, R2On_R1On_PSC_maxF, S2OnOff_R1On_PSC_ESYN, S2OnOff_R1On_PSC_tauD, S2OnOff_R1On_PSC_tauR, S2OnOff_R1On_PSC_delay, S2OnOff_R1On_PSC_gSYN, S2OnOff_R1On_PSC_fF, S2OnOff_R1On_PSC_fP, S2OnOff_R1On_PSC_tauF, S2OnOff_R1On_PSC_tauP, S2OnOff_R1On_PSC_maxF, R2On_S2OnOff_PSC_ESYN, R2On_S2OnOff_PSC_tauD, R2On_S2OnOff_PSC_tauR, R2On_S2OnOff_PSC_delay, R2On_S2OnOff_PSC_gSYN, R2On_S2OnOff_PSC_fF, R2On_S2OnOff_PSC_fP, R2On_S2OnOff_PSC_tauF, R2On_S2OnOff_PSC_tauP, R2On_S2OnOff_PSC_maxF, R2Off_S2OnOff_PSC_ESYN, R2Off_S2OnOff_PSC_tauD, R2Off_S2OnOff_PSC_tauR, R2Off_S2OnOff_PSC_delay, R2Off_S2OnOff_PSC_gSYN, R2Off_S2OnOff_PSC_fF, R2Off_S2OnOff_PSC_fP, R2Off_S2OnOff_PSC_tauF, R2Off_S2OnOff_PSC_tauP, R2Off_S2OnOff_PSC_maxF, R2Off_R1Off_PSC_ESYN, R2Off_R1Off_PSC_tauD, R2Off_R1Off_PSC_tauR, R2Off_R1Off_PSC_delay, R2Off_R1Off_PSC_gSYN, R2Off_R1Off_PSC_fF, R2Off_R1Off_PSC_fP, R2Off_R1Off_PSC_tauF, R2Off_R1Off_PSC_tauP, R2Off_R1Off_PSC_maxF, S2OnOff_R1Off_PSC_ESYN, S2OnOff_R1Off_PSC_tauD, S2OnOff_R1Off_PSC_tauR, S2OnOff_R1Off_PSC_delay, S2OnOff_R1Off_PSC_gSYN, S2OnOff_R1Off_PSC_fF, S2OnOff_R1Off_PSC_fP, S2OnOff_R1Off_PSC_tauF, S2OnOff_R1Off_PSC_tauP, S2OnOff_R1Off_PSC_maxF, R3On_R2On_PSC_ESYN, R3On_R2On_PSC_tauD, R3On_R2On_PSC_tauR, R3On_R2On_PSC_delay, R3On_R2On_PSC_gSYN, R3On_R2On_PSC_fF, R3On_R2On_PSC_fP, R3On_R2On_PSC_tauF, R3On_R2On_PSC_tauP, R3On_R2On_PSC_maxF, S3OnOff_R2On_PSC_ESYN, S3OnOff_R2On_PSC_tauD, S3OnOff_R2On_PSC_tauR, S3OnOff_R2On_PSC_delay, S3OnOff_R2On_PSC_gSYN, S3OnOff_R2On_PSC_fF, S3OnOff_R2On_PSC_fP, S3OnOff_R2On_PSC_tauF, S3OnOff_R2On_PSC_tauP, S3OnOff_R2On_PSC_maxF, R3On_S3OnOff_PSC_ESYN, R3On_S3OnOff_PSC_tauD, R3On_S3OnOff_PSC_tauR, R3On_S3OnOff_PSC_delay, R3On_S3OnOff_PSC_gSYN, R3On_S3OnOff_PSC_fF, R3On_S3OnOff_PSC_fP, R3On_S3OnOff_PSC_tauF, R3On_S3OnOff_PSC_tauP, R3On_S3OnOff_PSC_maxF, R3Off_S3OnOff_PSC_ESYN, R3Off_S3OnOff_PSC_tauD, R3Off_S3OnOff_PSC_tauR, R3Off_S3OnOff_PSC_delay, R3Off_S3OnOff_PSC_gSYN, R3Off_S3OnOff_PSC_fF, R3Off_S3OnOff_PSC_fP, R3Off_S3OnOff_PSC_tauF, R3Off_S3OnOff_PSC_tauP, R3Off_S3OnOff_PSC_maxF, R3Off_R2Off_PSC_ESYN, R3Off_R2Off_PSC_tauD, R3Off_R2Off_PSC_tauR, R3Off_R2Off_PSC_delay, R3Off_R2Off_PSC_gSYN, R3Off_R2Off_PSC_fF, R3Off_R2Off_PSC_fP, R3Off_R2Off_PSC_tauF, R3Off_R2Off_PSC_tauP, R3Off_R2Off_PSC_maxF, S3OnOff_R2Off_PSC_ESYN, S3OnOff_R2Off_PSC_tauD, S3OnOff_R2Off_PSC_tauR, S3OnOff_R2Off_PSC_delay, S3OnOff_R2Off_PSC_gSYN, S3OnOff_R2Off_PSC_fF, S3OnOff_R2Off_PSC_fP, S3OnOff_R2Off_PSC_tauF, S3OnOff_R2Off_PSC_tauP, S3OnOff_R2Off_PSC_maxF, R3On_R3On_iNoise_V3_FR, R3On_R3On_iNoise_V3_sigma, R3On_R3On_iNoise_V3_dt, R3On_R3On_iNoise_V3_nSYN, R3On_R3On_iNoise_V3_simlen, R3On_R3On_iNoise_V3_tauD_N, R3On_R3On_iNoise_V3_tauR_N, R3On_R3On_iNoise_V3_E_exc, ROn_X_PSC3_netcon, ROn_SOnOff_PSC3_netcon, C_ROn_PSC3_netcon)
...
R3On_Imask =  ones(1,R3On_Npop);
R3Off_R = 1/R3Off_g_L;
R3Off_tau = R3Off_C*R3Off_R;
R3Off_Imask =  ones(1,R3Off_Npop);
S3OnOff_R = 1/S3OnOff_g_L;
S3OnOff_tau = S3OnOff_C*S3OnOff_R;
S3OnOff_Imask =  ones(1,S3OnOff_Npop);
...
R3On_S3OnOff_PSC_netcon = eye(S3OnOff_Npop,R3On_Npop);
...
R3Off_S3OnOff_PSC_netcon = eye(S3OnOff_Npop,R3Off_Npop);
...
R3Off_R2Off_PSC_netcon = eye(R2Off_Npop,R3Off_Npop);
...
S3OnOff_R2Off_PSC_netcon = eye(R2Off_Npop,S3OnOff_Npop);
...
R3On_R3On_iNoise_V3_netcon =  eye(R3On_Npop,R3On_Npop);
R3On_R3On_iNoise_V3_token = genPoissonTimes(R3On_Npop,R3On_R3On_iNoise_V3_dt,R3On_R3On_iNoise_V3_FR,R3On_R3On_iNoise_V3_sigma,R3On_R3On_iNoise_V3_simlen);
...
R3On_V = zeros(2,R3On_Npop);
R3On_V(1,:) =  R3On_E_L*ones(1,R3On_Npop);
R3On_g_ad = zeros(2,R3On_Npop);
R3On_g_ad(1,:) =  zeros(1,R3On_Npop);
R3Off_V = zeros(2,R3Off_Npop);
R3Off_V(1,:) =  R3Off_E_L*ones(1,R3Off_Npop);
R3Off_g_ad = zeros(2,R3Off_Npop);
R3Off_g_ad(1,:) =  zeros(1,R3Off_Npop);
S3OnOff_V = zeros(2,S3OnOff_Npop);
S3OnOff_V(1,:) =  S3OnOff_E_L*ones(1,S3OnOff_Npop);
S3OnOff_g_ad = zeros(2,S3OnOff_Npop);
S3OnOff_g_ad(1,:) =  zeros(1,S3OnOff_Npop);
...
R3On_R2On_PSC_s = zeros(2,R2On_Npop);
R3On_R2On_PSC_s(1,:) =  zeros(1,R2On_Npop);
R3On_R2On_PSC_x = zeros(2,R2On_Npop);
R3On_R2On_PSC_x(1,:) =  zeros(1,R2On_Npop);
R3On_R2On_PSC_F = zeros(2,R2On_Npop);
R3On_R2On_PSC_F(1,:) =  ones(1,R2On_Npop);
R3On_R2On_PSC_P = zeros(2,R2On_Npop);
R3On_R2On_PSC_P(1,:) =  ones(1,R2On_Npop);
R3On_R2On_PSC_q = zeros(2,R2On_Npop);
R3On_R2On_PSC_q(1,:) =  ones(1,R2On_Npop);
S3OnOff_R2On_PSC_s = zeros(2,R2On_Npop);
S3OnOff_R2On_PSC_s(1,:) =  zeros(1,R2On_Npop);
S3OnOff_R2On_PSC_x = zeros(2,R2On_Npop);
S3OnOff_R2On_PSC_x(1,:) =  zeros(1,R2On_Npop);
S3OnOff_R2On_PSC_F = zeros(2,R2On_Npop);
S3OnOff_R2On_PSC_F(1,:) =  ones(1,R2On_Npop);
S3OnOff_R2On_PSC_P = zeros(2,R2On_Npop);
S3OnOff_R2On_PSC_P(1,:) =  ones(1,R2On_Npop);
S3OnOff_R2On_PSC_q = zeros(2,R2On_Npop);
S3OnOff_R2On_PSC_q(1,:) =  ones(1,R2On_Npop);
R3On_S3OnOff_PSC_s = zeros(2,S3OnOff_Npop);
R3On_S3OnOff_PSC_s(1,:) =  zeros(1,S3OnOff_Npop);
R3On_S3OnOff_PSC_x = zeros(2,S3OnOff_Npop);
R3On_S3OnOff_PSC_x(1,:) =  zeros(1,S3OnOff_Npop);
R3On_S3OnOff_PSC_F = zeros(2,S3OnOff_Npop);
R3On_S3OnOff_PSC_F(1,:) =  ones(1,S3OnOff_Npop);
R3On_S3OnOff_PSC_P = zeros(2,S3OnOff_Npop);
R3On_S3OnOff_PSC_P(1,:) =  ones(1,S3OnOff_Npop);
R3On_S3OnOff_PSC_q = zeros(2,S3OnOff_Npop);
R3On_S3OnOff_PSC_q(1,:) =  ones(1,S3OnOff_Npop);
R3Off_S3OnOff_PSC_s = zeros(2,S3OnOff_Npop);
R3Off_S3OnOff_PSC_s(1,:) =  zeros(1,S3OnOff_Npop);
R3Off_S3OnOff_PSC_x = zeros(2,S3OnOff_Npop);
R3Off_S3OnOff_PSC_x(1,:) =  zeros(1,S3OnOff_Npop);
R3Off_S3OnOff_PSC_F = zeros(2,S3OnOff_Npop);
R3Off_S3OnOff_PSC_F(1,:) =  ones(1,S3OnOff_Npop);
R3Off_S3OnOff_PSC_P = zeros(2,S3OnOff_Npop);
R3Off_S3OnOff_PSC_P(1,:) =  ones(1,S3OnOff_Npop);
R3Off_S3OnOff_PSC_q = zeros(2,S3OnOff_Npop);
R3Off_S3OnOff_PSC_q(1,:) =  ones(1,S3OnOff_Npop);
R3Off_R2Off_PSC_s = zeros(2,R2Off_Npop);
R3Off_R2Off_PSC_s(1,:) =  zeros(1,R2Off_Npop);
R3Off_R2Off_PSC_x = zeros(2,R2Off_Npop);
R3Off_R2Off_PSC_x(1,:) =  zeros(1,R2Off_Npop);
R3Off_R2Off_PSC_F = zeros(2,R2Off_Npop);
R3Off_R2Off_PSC_F(1,:) =  ones(1,R2Off_Npop);
R3Off_R2Off_PSC_P = zeros(2,R2Off_Npop);
R3Off_R2Off_PSC_P(1,:) =  ones(1,R2Off_Npop);
R3Off_R2Off_PSC_q = zeros(2,R2Off_Npop);
R3Off_R2Off_PSC_q(1,:) =  ones(1,R2Off_Npop);
S3OnOff_R2Off_PSC_s = zeros(2,R2Off_Npop);
S3OnOff_R2Off_PSC_s(1,:) =  zeros(1,R2Off_Npop);
S3OnOff_R2Off_PSC_x = zeros(2,R2Off_Npop);
S3OnOff_R2Off_PSC_x(1,:) =  zeros(1,R2Off_Npop);
S3OnOff_R2Off_PSC_F = zeros(2,R2Off_Npop);
S3OnOff_R2Off_PSC_F(1,:) =  ones(1,R2Off_Npop);
S3OnOff_R2Off_PSC_P = zeros(2,R2Off_Npop);
S3OnOff_R2Off_PSC_P(1,:) =  ones(1,R2Off_Npop);
S3OnOff_R2Off_PSC_q = zeros(2,R2Off_Npop);
S3OnOff_R2Off_PSC_q(1,:) =  ones(1,R2Off_Npop);
R3On_R3On_iNoise_V3_sn = zeros(2,R3On_Npop);
R3On_R3On_iNoise_V3_sn(1,:) =  0 * ones(1,R3On_Npop);
R3On_R3On_iNoise_V3_xn = zeros(2,R3On_Npop);
R3On_R3On_iNoise_V3_xn(1,:) =  0 * ones(1,R3On_Npop);
...
R3On_tspike = -1e32*ones(5,R3On_Npop);
R3On_buffer_index = ones(1,R3On_Npop);
R3On_V_spikes = zeros(nsamp,R3On_Npop);
R3Off_tspike = -1e32*ones(5,R3Off_Npop);
R3Off_buffer_index = ones(1,R3Off_Npop);
R3Off_V_spikes = zeros(nsamp,R3Off_Npop);
S3OnOff_tspike = -1e32*ones(5,S3OnOff_Npop);
S3OnOff_buffer_index = ones(1,S3OnOff_Npop);
S3OnOff_V_spikes = zeros(nsamp,S3OnOff_Npop);
...
R3On_R2On_PSC_syn = zeros(nsamp,R3On_Npop);
R3On_R2On_PSC_syn(1,:)=R3On_R2On_PSC_gSYN.*(R3On_R2On_PSC_s(1,:)*R3On_R2On_PSC_netcon).*(R3On_V(1,:)-R3On_R2On_PSC_ESYN);
S3OnOff_R2On_PSC_syn = zeros(nsamp,S3OnOff_Npop);
S3OnOff_R2On_PSC_syn(1,:)=S3OnOff_R2On_PSC_gSYN.*(S3OnOff_R2On_PSC_s(1,:)*S3OnOff_R2On_PSC_netcon).*(S3OnOff_V(1,:)-S3OnOff_R2On_PSC_ESYN);
R3On_S3OnOff_PSC_syn = zeros(nsamp,R3On_Npop);
R3On_S3OnOff_PSC_syn(1,:)=R3On_S3OnOff_PSC_gSYN.*(R3On_S3OnOff_PSC_s(1,:)*R3On_S3OnOff_PSC_netcon).*(R3On_V(1,:)-R3On_S3OnOff_PSC_ESYN);
R3Off_S3OnOff_PSC_syn = zeros(nsamp,R3Off_Npop);
R3Off_S3OnOff_PSC_syn(1,:)=R3Off_S3OnOff_PSC_gSYN.*(R3Off_S3OnOff_PSC_s(1,:)*R3Off_S3OnOff_PSC_netcon).*(R3Off_V(1,:)-R3Off_S3OnOff_PSC_ESYN);
R3Off_R2Off_PSC_syn = zeros(nsamp,R3Off_Npop);
R3Off_R2Off_PSC_syn(1,:)=R3Off_R2Off_PSC_gSYN.*(R3Off_R2Off_PSC_s(1,:)*R3Off_R2Off_PSC_netcon).*(R3Off_V(1,:)-R3Off_R2Off_PSC_ESYN);
S3OnOff_R2Off_PSC_syn = zeros(nsamp,S3OnOff_Npop);
S3OnOff_R2Off_PSC_syn(1,:)=S3OnOff_R2Off_PSC_gSYN.*(S3OnOff_R2Off_PSC_s(1,:)*S3OnOff_R2Off_PSC_netcon).*(S3OnOff_V(1,:)-S3OnOff_R2Off_PSC_ESYN);
...
for k=2:ntime
  ...
  R3On_V_k1 = ( (R3On_E_L-R3On_V(n-1,:)) - R3On_R*R3On_g_ad(n-1,:).*(R3On_V(n-1,:)-R3On_E_k) - R3On_R*((((R3On_R2On_PSC_gSYN.*(R3On_R2On_PSC_s(n-1,:)*R3On_R2On_PSC_netcon).*(R3On_V(n-1,:)-R3On_R2On_PSC_ESYN))))+((((R3On_S3OnOff_PSC_gSYN.*(R3On_S3OnOff_PSC_s(n-1,:)*R3On_S3OnOff_PSC_netcon).*(R3On_V(n-1,:)-R3On_S3OnOff_PSC_ESYN))))+((((R3On_R3On_iNoise_V3_nSYN.*(R3On_R3On_iNoise_V3_sn(n-1,:)*R3On_R3On_iNoise_V3_netcon).*(R3On_V(n-1,:)-R3On_R3On_iNoise_V3_E_exc))))))) + R3On_R*R3On_Itonic.*R3On_Imask + R3On_R*R3On_noise.*randn(1,R3On_Npop) ) / R3On_tau;
  R3On_g_ad_k1 = -R3On_g_ad(n-1,:) / R3On_tau_ad;
  R3Off_V_k1 = ( (R3Off_E_L-R3Off_V(n-1,:)) - R3Off_R*R3Off_g_ad(n-1,:).*(R3Off_V(n-1,:)-R3Off_E_k) - R3Off_R*((((R3Off_S3OnOff_PSC_gSYN.*(R3Off_S3OnOff_PSC_s(n-1,:)*R3Off_S3OnOff_PSC_netcon).*(R3Off_V(n-1,:)-R3Off_S3OnOff_PSC_ESYN))))+((((R3Off_R2Off_PSC_gSYN.*(R3Off_R2Off_PSC_s(n-1,:)*R3Off_R2Off_PSC_netcon).*(R3Off_V(n-1,:)-R3Off_R2Off_PSC_ESYN)))))) + R3Off_R*R3Off_Itonic.*R3Off_Imask + R3Off_R*R3Off_noise.*randn(1,R3Off_Npop) ) / R3Off_tau;
  R3Off_g_ad_k1 = -R3Off_g_ad(n-1,:) / R3Off_tau_ad;
  S3OnOff_V_k1 = ( (S3OnOff_E_L-S3OnOff_V(n-1,:)) - S3OnOff_R*S3OnOff_g_ad(n-1,:).*(S3OnOff_V(n-1,:)-S3OnOff_E_k) - S3OnOff_R*((((S3OnOff_R2On_PSC_gSYN.*(S3OnOff_R2On_PSC_s(n-1,:)*S3OnOff_R2On_PSC_netcon).*(S3OnOff_V(n-1,:)-S3OnOff_R2On_PSC_ESYN))))+((((S3OnOff_R2Off_PSC_gSYN.*(S3OnOff_R2Off_PSC_s(n-1,:)*S3OnOff_R2Off_PSC_netcon).*(S3OnOff_V(n-1,:)-S3OnOff_R2Off_PSC_ESYN)))))) + S3OnOff_R*S3OnOff_Itonic.*S3OnOff_Imask + S3OnOff_R*S3OnOff_noise.*randn(1,S3OnOff_Npop) ) / S3OnOff_tau;
  S3OnOff_g_ad_k1 = -S3OnOff_g_ad(n-1,:) / S3OnOff_tau_ad;
  ...
  R3On_R2On_PSC_s_k1 = ( R3On_R2On_PSC_scale * R3On_R2On_PSC_x(n-1,:) - R3On_R2On_PSC_s(n-1,:) )/R3On_R2On_PSC_tauR;
  R3On_R2On_PSC_x_k1 = -R3On_R2On_PSC_x(n-1,:)/R3On_R2On_PSC_tauD;
  R3On_R2On_PSC_F_k1 = (1 - R3On_R2On_PSC_F(n-1,:))/R3On_R2On_PSC_tauF;
  R3On_R2On_PSC_P_k1 = (1 - R3On_R2On_PSC_P(n-1,:))/R3On_R2On_PSC_tauP;
  R3On_R2On_PSC_q_k1 = 0;
  S3OnOff_R2On_PSC_s_k1 = ( S3OnOff_R2On_PSC_scale * S3OnOff_R2On_PSC_x(n-1,:) - S3OnOff_R2On_PSC_s(n-1,:) )/S3OnOff_R2On_PSC_tauR;
  S3OnOff_R2On_PSC_x_k1 = -S3OnOff_R2On_PSC_x(n-1,:)/S3OnOff_R2On_PSC_tauD;
  S3OnOff_R2On_PSC_F_k1 = (1 - S3OnOff_R2On_PSC_F(n-1,:))/S3OnOff_R2On_PSC_tauF;
  S3OnOff_R2On_PSC_P_k1 = (1 - S3OnOff_R2On_PSC_P(n-1,:))/S3OnOff_R2On_PSC_tauP;
  S3OnOff_R2On_PSC_q_k1 = 0;
  R3On_S3OnOff_PSC_s_k1 = ( R3On_S3OnOff_PSC_scale * R3On_S3OnOff_PSC_x(n-1,:) - R3On_S3OnOff_PSC_s(n-1,:) )/R3On_S3OnOff_PSC_tauR;
  R3On_S3OnOff_PSC_x_k1 = -R3On_S3OnOff_PSC_x(n-1,:)/R3On_S3OnOff_PSC_tauD;
  R3On_S3OnOff_PSC_F_k1 = (1 - R3On_S3OnOff_PSC_F(n-1,:))/R3On_S3OnOff_PSC_tauF;
  R3On_S3OnOff_PSC_P_k1 = (1 - R3On_S3OnOff_PSC_P(n-1,:))/R3On_S3OnOff_PSC_tauP;
  R3On_S3OnOff_PSC_q_k1 = 0;
  R3Off_S3OnOff_PSC_s_k1 = ( R3Off_S3OnOff_PSC_scale * R3Off_S3OnOff_PSC_x(n-1,:) - R3Off_S3OnOff_PSC_s(n-1,:) )/R3Off_S3OnOff_PSC_tauR;
  R3Off_S3OnOff_PSC_x_k1 = -R3Off_S3OnOff_PSC_x(n-1,:)/R3Off_S3OnOff_PSC_tauD;
  R3Off_S3OnOff_PSC_F_k1 = (1 - R3Off_S3OnOff_PSC_F(n-1,:))/R3Off_S3OnOff_PSC_tauF;
  R3Off_S3OnOff_PSC_P_k1 = (1 - R3Off_S3OnOff_PSC_P(n-1,:))/R3Off_S3OnOff_PSC_tauP;
  R3Off_S3OnOff_PSC_q_k1 = 0;
  R3Off_R2Off_PSC_s_k1 = ( R3Off_R2Off_PSC_scale * R3Off_R2Off_PSC_x(n-1,:) - R3Off_R2Off_PSC_s(n-1,:) )/R3Off_R2Off_PSC_tauR;
  R3Off_R2Off_PSC_x_k1 = -R3Off_R2Off_PSC_x(n-1,:)/R3Off_R2Off_PSC_tauD;
  R3Off_R2Off_PSC_F_k1 = (1 - R3Off_R2Off_PSC_F(n-1,:))/R3Off_R2Off_PSC_tauF;
  R3Off_R2Off_PSC_P_k1 = (1 - R3Off_R2Off_PSC_P(n-1,:))/R3Off_R2Off_PSC_tauP;
  R3Off_R2Off_PSC_q_k1 = 0;
  S3OnOff_R2Off_PSC_s_k1 = ( S3OnOff_R2Off_PSC_scale * S3OnOff_R2Off_PSC_x(n-1,:) - S3OnOff_R2Off_PSC_s(n-1,:) )/S3OnOff_R2Off_PSC_tauR;
  S3OnOff_R2Off_PSC_x_k1 = -S3OnOff_R2Off_PSC_x(n-1,:)/S3OnOff_R2Off_PSC_tauD;
  S3OnOff_R2Off_PSC_F_k1 = (1 - S3OnOff_R2Off_PSC_F(n-1,:))/S3OnOff_R2Off_PSC_tauF;
  S3OnOff_R2Off_PSC_P_k1 = (1 - S3OnOff_R2Off_PSC_P(n-1,:))/S3OnOff_R2Off_PSC_tauP;
  S3OnOff_R2Off_PSC_q_k1 = 0;
  R3On_R3On_iNoise_V3_sn_k1 = ( R3On_R3On_iNoise_V3_scale * R3On_R3On_iNoise_V3_xn(n-1,:) - R3On_R3On_iNoise_V3_sn(n-1,:) )/R3On_R3On_iNoise_V3_tauR_N;
  R3On_R3On_iNoise_V3_xn_k1 = -R3On_R3On_iNoise_V3_xn(n-1,:)/R3On_R3On_iNoise_V3_tauD_N + R3On_R3On_iNoise_V3_token(k,:)/R3On_R3On_iNoise_V3_dt;
  ...
  R3On_V(n,:) = R3On_V(n-1,:)+dt*R3On_V_k1;
  R3On_g_ad(n,:) = R3On_g_ad(n-1,:)+dt*R3On_g_ad_k1;
  R3Off_V(n,:) = R3Off_V(n-1,:)+dt*R3Off_V_k1;
  R3Off_g_ad(n,:) = R3Off_g_ad(n-1,:)+dt*R3Off_g_ad_k1;
  S3OnOff_V(n,:) = S3OnOff_V(n-1,:)+dt*S3OnOff_V_k1;
  S3OnOff_g_ad(n,:) = S3OnOff_g_ad(n-1,:)+dt*S3OnOff_g_ad_k1;
  ...
  R3On_R2On_PSC_s(n,:) = R3On_R2On_PSC_s(n-1,:)+dt*R3On_R2On_PSC_s_k1;
  R3On_R2On_PSC_x(n,:) = R3On_R2On_PSC_x(n-1,:)+dt*R3On_R2On_PSC_x_k1;
  R3On_R2On_PSC_F(n,:) = R3On_R2On_PSC_F(n-1,:)+dt*R3On_R2On_PSC_F_k1;
  R3On_R2On_PSC_P(n,:) = R3On_R2On_PSC_P(n-1,:)+dt*R3On_R2On_PSC_P_k1;
  R3On_R2On_PSC_q(n,:) = R3On_R2On_PSC_q(n-1,:)+dt*R3On_R2On_PSC_q_k1;
  S3OnOff_R2On_PSC_s(n,:) = S3OnOff_R2On_PSC_s(n-1,:)+dt*S3OnOff_R2On_PSC_s_k1;
  S3OnOff_R2On_PSC_x(n,:) = S3OnOff_R2On_PSC_x(n-1,:)+dt*S3OnOff_R2On_PSC_x_k1;
  S3OnOff_R2On_PSC_F(n,:) = S3OnOff_R2On_PSC_F(n-1,:)+dt*S3OnOff_R2On_PSC_F_k1;
  S3OnOff_R2On_PSC_P(n,:) = S3OnOff_R2On_PSC_P(n-1,:)+dt*S3OnOff_R2On_PSC_P_k1;
  S3OnOff_R2On_PSC_q(n,:) = S3OnOff_R2On_PSC_q(n-1,:)+dt*S3OnOff_R2On_PSC_q_k1;
  R3On_S3OnOff_PSC_s(n,:) = R3On_S3OnOff_PSC_s(n-1,:)+dt*R3On_S3OnOff_PSC_s_k1;
  R3On_S3OnOff_PSC_x(n,:) = R3On_S3OnOff_PSC_x(n-1,:)+dt*R3On_S3OnOff_PSC_x_k1;
  R3On_S3OnOff_PSC_F(n,:) = R3On_S3OnOff_PSC_F(n-1,:)+dt*R3On_S3OnOff_PSC_F_k1;
  R3On_S3OnOff_PSC_P(n,:) = R3On_S3OnOff_PSC_P(n-1,:)+dt*R3On_S3OnOff_PSC_P_k1;
  R3On_S3OnOff_PSC_q(n,:) = R3On_S3OnOff_PSC_q(n-1,:)+dt*R3On_S3OnOff_PSC_q_k1;
  R3Off_S3OnOff_PSC_s(n,:) = R3Off_S3OnOff_PSC_s(n-1,:)+dt*R3Off_S3OnOff_PSC_s_k1;
  R3Off_S3OnOff_PSC_x(n,:) = R3Off_S3OnOff_PSC_x(n-1,:)+dt*R3Off_S3OnOff_PSC_x_k1;
  R3Off_S3OnOff_PSC_F(n,:) = R3Off_S3OnOff_PSC_F(n-1,:)+dt*R3Off_S3OnOff_PSC_F_k1;
  R3Off_S3OnOff_PSC_P(n,:) = R3Off_S3OnOff_PSC_P(n-1,:)+dt*R3Off_S3OnOff_PSC_P_k1;
  R3Off_S3OnOff_PSC_q(n,:) = R3Off_S3OnOff_PSC_q(n-1,:)+dt*R3Off_S3OnOff_PSC_q_k1;
  R3Off_R2Off_PSC_s(n,:) = R3Off_R2Off_PSC_s(n-1,:)+dt*R3Off_R2Off_PSC_s_k1;
  R3Off_R2Off_PSC_x(n,:) = R3Off_R2Off_PSC_x(n-1,:)+dt*R3Off_R2Off_PSC_x_k1;
  R3Off_R2Off_PSC_F(n,:) = R3Off_R2Off_PSC_F(n-1,:)+dt*R3Off_R2Off_PSC_F_k1;
  R3Off_R2Off_PSC_P(n,:) = R3Off_R2Off_PSC_P(n-1,:)+dt*R3Off_R2Off_PSC_P_k1;
  R3Off_R2Off_PSC_q(n,:) = R3Off_R2Off_PSC_q(n-1,:)+dt*R3Off_R2Off_PSC_q_k1;
  S3OnOff_R2Off_PSC_s(n,:) = S3OnOff_R2Off_PSC_s(n-1,:)+dt*S3OnOff_R2Off_PSC_s_k1;
  S3OnOff_R2Off_PSC_x(n,:) = S3OnOff_R2Off_PSC_x(n-1,:)+dt*S3OnOff_R2Off_PSC_x_k1;
  S3OnOff_R2Off_PSC_F(n,:) = S3OnOff_R2Off_PSC_F(n-1,:)+dt*S3OnOff_R2Off_PSC_F_k1;
  S3OnOff_R2Off_PSC_P(n,:) = S3OnOff_R2Off_PSC_P(n-1,:)+dt*S3OnOff_R2Off_PSC_P_k1;
  S3OnOff_R2Off_PSC_q(n,:) = S3OnOff_R2Off_PSC_q(n-1,:)+dt*S3OnOff_R2Off_PSC_q_k1;
  R3On_R3On_iNoise_V3_sn(n,:) = R3On_R3On_iNoise_V3_sn(n-1,:)+dt*R3On_R3On_iNoise_V3_sn_k1;
  R3On_R3On_iNoise_V3_xn(n,:) = R3On_R3On_iNoise_V3_xn(n-1,:)+dt*R3On_R3On_iNoise_V3_xn_k1;

  % ------------------------------------------------------------
  % Conditional actions:
  % ------------------------------------------------------------
  conditional_test=any(S3OnOff_V(n,:)>=S3OnOff_V_thresh&S3OnOff_V(n-1,:)<S3OnOff_V_thresh);
  conditional_indx=(S3OnOff_V(n,:)>=S3OnOff_V_thresh&S3OnOff_V(n-1,:)<S3OnOff_V_thresh);
  if conditional_test, S3OnOff_V_spikes(n,conditional_indx)=1;inds=find(conditional_indx); for j=1:length(inds), i=inds(j); S3OnOff_tspike(S3OnOff_buffer_index(i),i)=t; S3OnOff_buffer_index(i)=mod(-1+(S3OnOff_buffer_index(i)+1),5)+1; end; end
  conditional_test=any(R3Off_V(n,:)>=R3Off_V_thresh&R3Off_V(n-1,:)<R3Off_V_thresh);
  conditional_indx=(R3Off_V(n,:)>=R3Off_V_thresh&R3Off_V(n-1,:)<R3Off_V_thresh);
  if conditional_test, R3Off_V_spikes(n,conditional_indx)=1;inds=find(conditional_indx); for j=1:length(inds), i=inds(j); R3Off_tspike(R3Off_buffer_index(i),i)=t; R3Off_buffer_index(i)=mod(-1+(R3Off_buffer_index(i)+1),5)+1; end; end
  conditional_test=any(R3On_V(n,:)>=R3On_V_thresh&R3On_V(n-1,:)<R3On_V_thresh);
  conditional_indx=(R3On_V(n,:)>=R3On_V_thresh&R3On_V(n-1,:)<R3On_V_thresh);
  if conditional_test, R3On_V_spikes(n,conditional_indx)=1;inds=find(conditional_indx); for j=1:length(inds), i=inds(j); R3On_tspike(R3On_buffer_index(i),i)=t; R3On_buffer_index(i)=mod(-1+(R3On_buffer_index(i)+1),5)+1; end; end
  ...
  conditional_test=any(R3On_V(n,:) > R3On_V_thresh);
  conditional_indx=(R3On_V(n,:) > R3On_V_thresh);
  if conditional_test, R3On_V(n,conditional_indx) = R3On_V_reset; R3On_g_ad(n,conditional_indx) = R3On_g_ad(n,conditional_indx) + R3On_g_inc; end
  conditional_test=any(any(t<=R3On_tspike+R3On_t_ref,1));
  conditional_indx=(any(t<=R3On_tspike+R3On_t_ref,1));
  if conditional_test, R3On_V(n,conditional_indx) = R3On_V_reset; end
  conditional_test=any(R3Off_V(n,:) > R3Off_V_thresh);
  conditional_indx=(R3Off_V(n,:) > R3Off_V_thresh);
  if conditional_test, R3Off_V(n,conditional_indx) = R3Off_V_reset; R3Off_g_ad(n,conditional_indx) = R3Off_g_ad(n,conditional_indx) + R3Off_g_inc; end
  conditional_test=any(any(t<=R3Off_tspike+R3Off_t_ref,1));
  conditional_indx=(any(t<=R3Off_tspike+R3Off_t_ref,1));
  if conditional_test, R3Off_V(n,conditional_indx) = R3Off_V_reset; end
  conditional_test=any(S3OnOff_V(n,:) > S3OnOff_V_thresh);
  conditional_indx=(S3OnOff_V(n,:) > S3OnOff_V_thresh);
  if conditional_test, S3OnOff_V(n,conditional_indx) = S3OnOff_V_reset; S3OnOff_g_ad(n,conditional_indx) = S3OnOff_g_ad(n,conditional_indx) + S3OnOff_g_inc; end
  conditional_test=any(any(t<=S3OnOff_tspike+S3OnOff_t_ref,1));
  conditional_indx=(any(t<=S3OnOff_tspike+S3OnOff_t_ref,1));
  if conditional_test, S3OnOff_V(n,conditional_indx) = S3OnOff_V_reset; end
  ...
  conditional_test=any(any(t == R2On_tspike+R3On_R2On_PSC_delay,1));
  conditional_indx=(any(t == R2On_tspike+R3On_R2On_PSC_delay,1));
  if conditional_test, R3On_R2On_PSC_x(n,conditional_indx) = R3On_R2On_PSC_x(n,conditional_indx) + R3On_R2On_PSC_q(n,conditional_indx);R3On_R2On_PSC_q(n,conditional_indx) = R3On_R2On_PSC_F(n,conditional_indx).*R3On_R2On_PSC_P(n,conditional_indx);R3On_R2On_PSC_F(n,conditional_indx) = R3On_R2On_PSC_F(n,conditional_indx) + R3On_R2On_PSC_fF*(R3On_R2On_PSC_maxF-R3On_R2On_PSC_F(n,conditional_indx)); R3On_R2On_PSC_P(n,conditional_indx) = R3On_R2On_PSC_P(n,conditional_indx)*(1 - R3On_R2On_PSC_fP); end
  conditional_test=any(any(t == R2On_tspike+S3OnOff_R2On_PSC_delay,1));
  conditional_indx=(any(t == R2On_tspike+S3OnOff_R2On_PSC_delay,1));
  if conditional_test, S3OnOff_R2On_PSC_x(n,conditional_indx) = S3OnOff_R2On_PSC_x(n,conditional_indx) + S3OnOff_R2On_PSC_q(n,conditional_indx);S3OnOff_R2On_PSC_q(n,conditional_indx) = S3OnOff_R2On_PSC_F(n,conditional_indx).*S3OnOff_R2On_PSC_P(n,conditional_indx);S3OnOff_R2On_PSC_F(n,conditional_indx) = S3OnOff_R2On_PSC_F(n,conditional_indx) + S3OnOff_R2On_PSC_fF*(S3OnOff_R2On_PSC_maxF-S3OnOff_R2On_PSC_F(n,conditional_indx)); S3OnOff_R2On_PSC_P(n,conditional_indx) = S3OnOff_R2On_PSC_P(n,conditional_indx)*(1 - S3OnOff_R2On_PSC_fP); end
  conditional_test=any(any(t == S3OnOff_tspike+R3On_S3OnOff_PSC_delay,1));
  conditional_indx=(any(t == S3OnOff_tspike+R3On_S3OnOff_PSC_delay,1));
  if conditional_test, R3On_S3OnOff_PSC_x(n,conditional_indx) = R3On_S3OnOff_PSC_x(n,conditional_indx) + R3On_S3OnOff_PSC_q(n,conditional_indx);R3On_S3OnOff_PSC_q(n,conditional_indx) = R3On_S3OnOff_PSC_F(n,conditional_indx).*R3On_S3OnOff_PSC_P(n,conditional_indx);R3On_S3OnOff_PSC_F(n,conditional_indx) = R3On_S3OnOff_PSC_F(n,conditional_indx) + R3On_S3OnOff_PSC_fF*(R3On_S3OnOff_PSC_maxF-R3On_S3OnOff_PSC_F(n,conditional_indx)); R3On_S3OnOff_PSC_P(n,conditional_indx) = R3On_S3OnOff_PSC_P(n,conditional_indx)*(1 - R3On_S3OnOff_PSC_fP); end
  conditional_test=any(any(t == S3OnOff_tspike+R3Off_S3OnOff_PSC_delay,1));
  conditional_indx=(any(t == S3OnOff_tspike+R3Off_S3OnOff_PSC_delay,1));
  if conditional_test, R3Off_S3OnOff_PSC_x(n,conditional_indx) = R3Off_S3OnOff_PSC_x(n,conditional_indx) + R3Off_S3OnOff_PSC_q(n,conditional_indx);R3Off_S3OnOff_PSC_q(n,conditional_indx) = R3Off_S3OnOff_PSC_F(n,conditional_indx).*R3Off_S3OnOff_PSC_P(n,conditional_indx);R3Off_S3OnOff_PSC_F(n,conditional_indx) = R3Off_S3OnOff_PSC_F(n,conditional_indx) + R3Off_S3OnOff_PSC_fF*(R3Off_S3OnOff_PSC_maxF-R3Off_S3OnOff_PSC_F(n,conditional_indx)); R3Off_S3OnOff_PSC_P(n,conditional_indx) = R3Off_S3OnOff_PSC_P(n,conditional_indx)*(1 - R3Off_S3OnOff_PSC_fP); end
  conditional_test=any(any(t == R2Off_tspike+R3Off_R2Off_PSC_delay,1));
  conditional_indx=(any(t == R2Off_tspike+R3Off_R2Off_PSC_delay,1));
  if conditional_test, R3Off_R2Off_PSC_x(n,conditional_indx) = R3Off_R2Off_PSC_x(n,conditional_indx) + R3Off_R2Off_PSC_q(n,conditional_indx);R3Off_R2Off_PSC_q(n,conditional_indx) = R3Off_R2Off_PSC_F(n,conditional_indx).*R3Off_R2Off_PSC_P(n,conditional_indx);R3Off_R2Off_PSC_F(n,conditional_indx) = R3Off_R2Off_PSC_F(n,conditional_indx) + R3Off_R2Off_PSC_fF*(R3Off_R2Off_PSC_maxF-R3Off_R2Off_PSC_F(n,conditional_indx)); R3Off_R2Off_PSC_P(n,conditional_indx) = R3Off_R2Off_PSC_P(n,conditional_indx)*(1 - R3Off_R2Off_PSC_fP); end
  conditional_test=any(any(t == R2Off_tspike+S3OnOff_R2Off_PSC_delay,1));
  conditional_indx=(any(t == R2Off_tspike+S3OnOff_R2Off_PSC_delay,1));
  if conditional_test, S3OnOff_R2Off_PSC_x(n,conditional_indx) = S3OnOff_R2Off_PSC_x(n,conditional_indx) + S3OnOff_R2Off_PSC_q(n,conditional_indx);S3OnOff_R2Off_PSC_q(n,conditional_indx) = S3OnOff_R2Off_PSC_F(n,conditional_indx).*S3OnOff_R2Off_PSC_P(n,conditional_indx);S3OnOff_R2Off_PSC_F(n,conditional_indx) = S3OnOff_R2Off_PSC_F(n,conditional_indx) + S3OnOff_R2Off_PSC_fF*(S3OnOff_R2Off_PSC_maxF-S3OnOff_R2Off_PSC_F(n,conditional_indx)); S3OnOff_R2Off_PSC_P(n,conditional_indx) = S3OnOff_R2Off_PSC_P(n,conditional_indx)*(1 - S3OnOff_R2Off_PSC_fP); end
  ...
  R3On_R2On_PSC_syn(n,:)=R3On_R2On_PSC_gSYN.*(R3On_R2On_PSC_s(n,:)*R3On_R2On_PSC_netcon).*(R3On_V(n,:)-R3On_R2On_PSC_ESYN);
  S3OnOff_R2On_PSC_syn(n,:)=S3OnOff_R2On_PSC_gSYN.*(S3OnOff_R2On_PSC_s(n,:)*S3OnOff_R2On_PSC_netcon).*(S3OnOff_V(n,:)-S3OnOff_R2On_PSC_ESYN);
  R3On_S3OnOff_PSC_syn(n,:)=R3On_S3OnOff_PSC_gSYN.*(R3On_S3OnOff_PSC_s(n,:)*R3On_S3OnOff_PSC_netcon).*(R3On_V(n,:)-R3On_S3OnOff_PSC_ESYN);
  R3Off_S3OnOff_PSC_syn(n,:)=R3Off_S3OnOff_PSC_gSYN.*(R3Off_S3OnOff_PSC_s(n,:)*R3Off_S3OnOff_PSC_netcon).*(R3Off_V(n,:)-R3Off_S3OnOff_PSC_ESYN);
  R3Off_R2Off_PSC_syn(n,:)=R3Off_R2Off_PSC_gSYN.*(R3Off_R2Off_PSC_s(n,:)*R3Off_R2Off_PSC_netcon).*(R3Off_V(n,:)-R3Off_R2Off_PSC_ESYN);
  S3OnOff_R2Off_PSC_syn(n,:)=S3OnOff_R2Off_PSC_gSYN.*(S3OnOff_R2Off_PSC_s(n,:)*S3OnOff_R2Off_PSC_netcon).*(S3OnOff_V(n,:)-S3OnOff_R2Off_PSC_ESYN);
  n=n+1;
end
