...
%
function [wholeStim, groupIndex, stimInfo, params] = preprocSound_STRF(audioWaveforms, params)
...
%         else
            %\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
            stim.tfrep = timefreq_STRF(audioWaveforms{k}, params.rawSampleRate, params.tfType, params.tfParams);  
            %/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\
