...
for k = 1:10
    ...
    SpikeTimes = all_data(124).ctrl_tar1_timestamps{k,1};  %(10 x 4) %As it stands (look at animal at index 124 and the timestamps associated with the first location and iterate over all 10 trials)
