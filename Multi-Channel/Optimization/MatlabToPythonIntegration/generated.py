...
class LIF_ODE(nn.Module):
    ...
    def forward(self,t,state):
        ...
        #ODEs
        On_V_k1 = ( (self.On_E_L-On_V) - On_R*On_g_ad.*(On_V-self.On_E_k) - On_R*((((self.On_On_IC_g_postIC*(On_On_IC_input(k,:)*On_On_IC_netcon).*(On_V-self.On_On_IC_E_exc))))) + On_R*self.On_Itonic.*On_Imask + On_R*self.On_noise.*randn(1,self.On_Npop) ) / On_tau
        On_g_ad_k1 = -On_g_ad / self.On_tau_ad
        Off_V_k1 = ( (self.Off_E_L-Off_V) - Off_R*Off_g_ad.*(Off_V-self.Off_E_k) - Off_R*((((self.Off_Off_IC_g_postIC*(Off_Off_IC_input(k,:)*Off_Off_IC_netcon).*(Off_V-self.Off_Off_IC_E_exc))))) + Off_R*self.Off_Itonic.*Off_Imask + Off_R*self.Off_noise.*randn(1,self.Off_Npop) ) / Off_tau
        Off_g_ad_k1 = -Off_g_ad / self.Off_tau_ad
        R1On_V_k1 = ( (self.R1On_E_L-R1On_V) - R1On_R*R1On_g_ad.*(R1On_V-self.R1On_E_k) - R1On_R*((((self.R1On_On_PSC_gSYN.*(R1On_On_PSC_s*R1On_On_PSC_netcon).*(R1On_V-self.R1On_On_PSC_ESYN))))+((((self.R1On_S1OnOff_PSC_gSYN.*(R1On_S1OnOff_PSC_s*R1On_S1OnOff_PSC_netcon).*(R1On_V-self.R1On_S1OnOff_PSC_ESYN)))))) + R1On_R*self.R1On_Itonic.*R1On_Imask + R1On_R*self.R1On_noise.*randn(1,self.R1On_Npop) ) / R1On_tau
        R1On_g_ad_k1 = -R1On_g_ad / self.R1On_tau_ad
        R1Off_V_k1 = ( (self.R1Off_E_L-R1Off_V) - R1Off_R*R1Off_g_ad.*(R1Off_V-self.R1Off_E_k) - R1Off_R*((((self.R1Off_S1OnOff_PSC_gSYN.*(R1Off_S1OnOff_PSC_s*R1Off_S1OnOff_PSC_netcon).*(R1Off_V-self.R1Off_S1OnOff_PSC_ESYN))))+((((self.R1Off_Off_PSC_gSYN.*(R1Off_Off_PSC_s*R1Off_Off_PSC_netcon).*(R1Off_V-self.R1Off_Off_PSC_ESYN)))))) + R1Off_R*self.R1Off_Itonic.*R1Off_Imask + R1Off_R*self.R1Off_noise.*randn(1,self.R1Off_Npop) ) / R1Off_tau
        R1Off_g_ad_k1 = -R1Off_g_ad / self.R1Off_tau_ad
        S1OnOff_V_k1 = ( (self.S1OnOff_E_L-S1OnOff_V) - S1OnOff_R*S1OnOff_g_ad.*(S1OnOff_V-self.S1OnOff_E_k) - S1OnOff_R*((((self.S1OnOff_On_PSC_gSYN.*(S1OnOff_On_PSC_s*S1OnOff_On_PSC_netcon).*(S1OnOff_V-self.S1OnOff_On_PSC_ESYN))))+((((self.S1OnOff_Off_PSC_gSYN.*(S1OnOff_Off_PSC_s*S1OnOff_Off_PSC_netcon).*(S1OnOff_V-self.S1OnOff_Off_PSC_ESYN)))))) + S1OnOff_R*self.S1OnOff_Itonic.*S1OnOff_Imask + S1OnOff_R*self.S1OnOff_noise.*randn(1,self.S1OnOff_Npop) ) / S1OnOff_tau
        S1OnOff_g_ad_k1 = -S1OnOff_g_ad / self.S1OnOff_tau_ad
        R2On_V_k1 = ( (self.R2On_E_L-R2On_V) - R2On_R*R2On_g_ad.*(R2On_V-self.R2On_E_k) - R2On_R*((((self.R2On_R1On_PSC_gSYN.*(R2On_R1On_PSC_s*R2On_R1On_PSC_netcon).*(R2On_V-self.R2On_R1On_PSC_ESYN))))+((((self.R2On_S2OnOff_PSC_gSYN.*(R2On_S2OnOff_PSC_s*R2On_S2OnOff_PSC_netcon).*(R2On_V-self.R2On_S2OnOff_PSC_ESYN))))+((((self.R2On_R2On_iNoise_V3_nSYN.*(R2On_R2On_iNoise_V3_sn*R2On_R2On_iNoise_V3_netcon).*(R2On_V-self.R2On_R2On_iNoise_V3_E_exc))))))) + R2On_R*self.R2On_Itonic.*R2On_Imask + R2On_R*self.R2On_noise.*randn(1,self.R2On_Npop) ) / R2On_tau
        R2On_g_ad_k1 = -R2On_g_ad / self.R2On_tau_ad
        R2Off_V_k1 = ( (self.R2Off_E_L-R2Off_V) - R2Off_R*R2Off_g_ad.*(R2Off_V-self.R2Off_E_k) - R2Off_R*((((self.R2Off_S2OnOff_PSC_gSYN.*(R2Off_S2OnOff_PSC_s*R2Off_S2OnOff_PSC_netcon).*(R2Off_V-self.R2Off_S2OnOff_PSC_ESYN))))+((((self.R2Off_R1Off_PSC_gSYN.*(R2Off_R1Off_PSC_s*R2Off_R1Off_PSC_netcon).*(R2Off_V-self.R2Off_R1Off_PSC_ESYN)))))) + R2Off_R*self.R2Off_Itonic.*R2Off_Imask + R2Off_R*self.R2Off_noise.*randn(1,self.R2Off_Npop) ) / R2Off_tau
        R2Off_g_ad_k1 = -R2Off_g_ad / self.R2Off_tau_ad
        S2OnOff_V_k1 = ( (self.S2OnOff_E_L-S2OnOff_V) - S2OnOff_R*S2OnOff_g_ad.*(S2OnOff_V-self.S2OnOff_E_k) - S2OnOff_R*((((self.S2OnOff_R1On_PSC_gSYN.*(S2OnOff_R1On_PSC_s*S2OnOff_R1On_PSC_netcon).*(S2OnOff_V-self.S2OnOff_R1On_PSC_ESYN))))+((((self.S2OnOff_R1Off_PSC_gSYN.*(S2OnOff_R1Off_PSC_s*S2OnOff_R1Off_PSC_netcon).*(S2OnOff_V-self.S2OnOff_R1Off_PSC_ESYN)))))) + S2OnOff_R*self.S2OnOff_Itonic.*S2OnOff_Imask + S2OnOff_R*self.S2OnOff_noise.*randn(1,self.S2OnOff_Npop) ) / S2OnOff_tau
        S2OnOff_g_ad_k1 = -S2OnOff_g_ad / self.S2OnOff_tau_ad
        R1On_On_PSC_s_k1 = ( R1On_On_PSC_scale * R1On_On_PSC_x - R1On_On_PSC_s )/self.R1On_On_PSC_tauR
        R1On_On_PSC_x_k1 = -R1On_On_PSC_x/self.R1On_On_PSC_tauD
        R1On_On_PSC_F_k1 = (1 - R1On_On_PSC_F)/self.R1On_On_PSC_tauF
        R1On_On_PSC_P_k1 = (1 - R1On_On_PSC_P)/self.R1On_On_PSC_tauP
        R1On_On_PSC_q_k1 = 0
        S1OnOff_On_PSC_s_k1 = ( S1OnOff_On_PSC_scale * S1OnOff_On_PSC_x - S1OnOff_On_PSC_s )/self.S1OnOff_On_PSC_tauR
        S1OnOff_On_PSC_x_k1 = -S1OnOff_On_PSC_x/self.S1OnOff_On_PSC_tauD
        S1OnOff_On_PSC_F_k1 = (1 - S1OnOff_On_PSC_F)/self.S1OnOff_On_PSC_tauF
        S1OnOff_On_PSC_P_k1 = (1 - S1OnOff_On_PSC_P)/self.S1OnOff_On_PSC_tauP
        S1OnOff_On_PSC_q_k1 = 0
        R1On_S1OnOff_PSC_s_k1 = ( R1On_S1OnOff_PSC_scale * R1On_S1OnOff_PSC_x - R1On_S1OnOff_PSC_s )/self.R1On_S1OnOff_PSC_tauR
        R1On_S1OnOff_PSC_x_k1 = -R1On_S1OnOff_PSC_x/self.R1On_S1OnOff_PSC_tauD
        R1On_S1OnOff_PSC_F_k1 = (1 - R1On_S1OnOff_PSC_F)/self.R1On_S1OnOff_PSC_tauF
        R1On_S1OnOff_PSC_P_k1 = (1 - R1On_S1OnOff_PSC_P)/self.R1On_S1OnOff_PSC_tauP
        R1On_S1OnOff_PSC_q_k1 = 0
        R1Off_S1OnOff_PSC_s_k1 = ( R1Off_S1OnOff_PSC_scale * R1Off_S1OnOff_PSC_x - R1Off_S1OnOff_PSC_s )/self.R1Off_S1OnOff_PSC_tauR
        R1Off_S1OnOff_PSC_x_k1 = -R1Off_S1OnOff_PSC_x/self.R1Off_S1OnOff_PSC_tauD
        R1Off_S1OnOff_PSC_F_k1 = (1 - R1Off_S1OnOff_PSC_F)/self.R1Off_S1OnOff_PSC_tauF
        R1Off_S1OnOff_PSC_P_k1 = (1 - R1Off_S1OnOff_PSC_P)/self.R1Off_S1OnOff_PSC_tauP
        R1Off_S1OnOff_PSC_q_k1 = 0
        R1Off_Off_PSC_s_k1 = ( R1Off_Off_PSC_scale * R1Off_Off_PSC_x - R1Off_Off_PSC_s )/self.R1Off_Off_PSC_tauR
        R1Off_Off_PSC_x_k1 = -R1Off_Off_PSC_x/self.R1Off_Off_PSC_tauD
        R1Off_Off_PSC_F_k1 = (1 - R1Off_Off_PSC_F)/self.R1Off_Off_PSC_tauF
        R1Off_Off_PSC_P_k1 = (1 - R1Off_Off_PSC_P)/self.R1Off_Off_PSC_tauP
        R1Off_Off_PSC_q_k1 = 0
        S1OnOff_Off_PSC_s_k1 = ( S1OnOff_Off_PSC_scale * S1OnOff_Off_PSC_x - S1OnOff_Off_PSC_s )/self.S1OnOff_Off_PSC_tauR
        S1OnOff_Off_PSC_x_k1 = -S1OnOff_Off_PSC_x/self.S1OnOff_Off_PSC_tauD
        S1OnOff_Off_PSC_F_k1 = (1 - S1OnOff_Off_PSC_F)/self.S1OnOff_Off_PSC_tauF
        S1OnOff_Off_PSC_P_k1 = (1 - S1OnOff_Off_PSC_P)/self.S1OnOff_Off_PSC_tauP
        S1OnOff_Off_PSC_q_k1 = 0
        R2On_R1On_PSC_s_k1 = ( R2On_R1On_PSC_scale * R2On_R1On_PSC_x - R2On_R1On_PSC_s )/self.R2On_R1On_PSC_tauR
        R2On_R1On_PSC_x_k1 = -R2On_R1On_PSC_x/self.R2On_R1On_PSC_tauD
        R2On_R1On_PSC_F_k1 = (1 - R2On_R1On_PSC_F)/self.R2On_R1On_PSC_tauF
        R2On_R1On_PSC_P_k1 = (1 - R2On_R1On_PSC_P)/self.R2On_R1On_PSC_tauP
        R2On_R1On_PSC_q_k1 = 0
        S2OnOff_R1On_PSC_s_k1 = ( S2OnOff_R1On_PSC_scale * S2OnOff_R1On_PSC_x - S2OnOff_R1On_PSC_s )/self.S2OnOff_R1On_PSC_tauR
        S2OnOff_R1On_PSC_x_k1 = -S2OnOff_R1On_PSC_x/self.S2OnOff_R1On_PSC_tauD
        S2OnOff_R1On_PSC_F_k1 = (1 - S2OnOff_R1On_PSC_F)/self.S2OnOff_R1On_PSC_tauF
        S2OnOff_R1On_PSC_P_k1 = (1 - S2OnOff_R1On_PSC_P)/self.S2OnOff_R1On_PSC_tauP
        S2OnOff_R1On_PSC_q_k1 = 0
        R2On_S2OnOff_PSC_s_k1 = ( R2On_S2OnOff_PSC_scale * R2On_S2OnOff_PSC_x - R2On_S2OnOff_PSC_s )/self.R2On_S2OnOff_PSC_tauR
        R2On_S2OnOff_PSC_x_k1 = -R2On_S2OnOff_PSC_x/self.R2On_S2OnOff_PSC_tauD
        R2On_S2OnOff_PSC_F_k1 = (1 - R2On_S2OnOff_PSC_F)/self.R2On_S2OnOff_PSC_tauF
        R2On_S2OnOff_PSC_P_k1 = (1 - R2On_S2OnOff_PSC_P)/self.R2On_S2OnOff_PSC_tauP
        R2On_S2OnOff_PSC_q_k1 = 0
        R2Off_S2OnOff_PSC_s_k1 = ( R2Off_S2OnOff_PSC_scale * R2Off_S2OnOff_PSC_x - R2Off_S2OnOff_PSC_s )/self.R2Off_S2OnOff_PSC_tauR
        R2Off_S2OnOff_PSC_x_k1 = -R2Off_S2OnOff_PSC_x/self.R2Off_S2OnOff_PSC_tauD
        R2Off_S2OnOff_PSC_F_k1 = (1 - R2Off_S2OnOff_PSC_F)/self.R2Off_S2OnOff_PSC_tauF
        R2Off_S2OnOff_PSC_P_k1 = (1 - R2Off_S2OnOff_PSC_P)/self.R2Off_S2OnOff_PSC_tauP
        R2Off_S2OnOff_PSC_q_k1 = 0
        R2Off_R1Off_PSC_s_k1 = ( R2Off_R1Off_PSC_scale * R2Off_R1Off_PSC_x - R2Off_R1Off_PSC_s )/self.R2Off_R1Off_PSC_tauR
        R2Off_R1Off_PSC_x_k1 = -R2Off_R1Off_PSC_x/self.R2Off_R1Off_PSC_tauD
        R2Off_R1Off_PSC_F_k1 = (1 - R2Off_R1Off_PSC_F)/self.R2Off_R1Off_PSC_tauF
        R2Off_R1Off_PSC_P_k1 = (1 - R2Off_R1Off_PSC_P)/self.R2Off_R1Off_PSC_tauP
        R2Off_R1Off_PSC_q_k1 = 0
        S2OnOff_R1Off_PSC_s_k1 = ( S2OnOff_R1Off_PSC_scale * S2OnOff_R1Off_PSC_x - S2OnOff_R1Off_PSC_s )/self.S2OnOff_R1Off_PSC_tauR
        S2OnOff_R1Off_PSC_x_k1 = -S2OnOff_R1Off_PSC_x/self.S2OnOff_R1Off_PSC_tauD
        S2OnOff_R1Off_PSC_F_k1 = (1 - S2OnOff_R1Off_PSC_F)/self.S2OnOff_R1Off_PSC_tauF
        S2OnOff_R1Off_PSC_P_k1 = (1 - S2OnOff_R1Off_PSC_P)/self.S2OnOff_R1Off_PSC_tauP
        S2OnOff_R1Off_PSC_q_k1 = 0
        R2On_R2On_iNoise_V3_sn_k1 = ( R2On_R2On_iNoise_V3_scale * R2On_R2On_iNoise_V3_xn - R2On_R2On_iNoise_V3_sn )/self.R2On_R2On_iNoise_V3_tauR_N
        R2On_R2On_iNoise_V3_xn_k1 = -R2On_R2On_iNoise_V3_xn/self.R2On_R2On_iNoise_V3_tauD_N + R2On_R2On_iNoise_V3_token(k,:)/self.R2On_R2On_iNoise_V3_dt
