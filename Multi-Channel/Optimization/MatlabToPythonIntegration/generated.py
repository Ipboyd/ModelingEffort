    ...
    def forward(self):
        ...
        for num_trials_count in range(10):
            ...
            for t in range(1,T):
                ...
                On_V_test = SurrogateSpike.apply(On_V[-1], On_V[-2], self.On_V_thresh)
                if On_V_test:
                ...
                Off_V_test = SurrogateSpike.apply(Off_V[-1], Off_V[-2], self.Off_V_thresh)
                if Off_V_test:
                ...
                R1On_V_test = SurrogateSpike.apply(R1On_V[-1], R1On_V[-2], self.R1On_V_thresh)
                if R1On_V_test:
                ...
                R1Off_V_test = SurrogateSpike.apply(R1Off_V[-1], R1Off_V[-2], self.R1Off_V_thresh)
                if R1Off_V_test:
                ...
                S1OnOff_V_test = SurrogateSpike.apply(S1OnOff_V[-1], S1OnOff_V[-2], self.S1OnOff_V_thresh)
                if S1OnOff_V_test:
                ...
                R2On_V_test = SurrogateSpike.apply(R2On_V[-1], R2On_V[-2], self.R2On_V_thresh)
                if R2On_V_test:
                ...
                R2Off_V_test = SurrogateSpike.apply(R2Off_V[-1], R2Off_V[-2], self.R2Off_V_thresh)
                if R2Off_V_test:
                ...
                S2OnOff_V_test = SurrogateSpike.apply(S2OnOff_V[-1], S2OnOff_V[-2], self.S2OnOff_V_thresh)
                if S2OnOff_V_test:
